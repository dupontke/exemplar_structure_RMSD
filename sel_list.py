...
sel.append(['full_protein','protein and not name H*','protein and not name H*'])
sel.append(['full_backbone','backbone','backbone'])
sel.append(['protein-19','protein and not resid 0:19 and not name H*'])
sel.append(['backbone-19','backbone and not resid 0:19'])
#sel.append(['motif_1','protein and resid 26:35 and not name H*'])
#sel.append(['motif_1a','protein and resid 54:63 and not name H*'])
#sel.append(['a2_1','protein and resid 62:69 and not name H*'])
sel.append(['Lb3b4_1','protein and resid 75:88 and not name H*'])
#sel.append(['motif_1c','protein and resid 96:100 and not name H*'])
sel.append(['motif_2','protein and resid 115:122 and not name H*'])
#sel.append(['motif_3','protein and resid 147:151 and not name H*'])
#sel.append(['post_m_3','protein and resid 151:162 and not name H*'])
#sel.append(['motif_4','protein and resid 192:197 and not name H*'])
sel.append(['motif_4a','protein and resid 216:223 and not name H*'])
#sel.append(['post_m_4a','protein and resid 225:234 and not name H*'])
sel.append(['motif_5','protein and resid 237:249 and not name H*'])
sel.append(['beta_wedges','protein and resid 260:280 and not name H*'])
#sel.append(['motif_6','protein and resid 289:300 and not name H*'])
